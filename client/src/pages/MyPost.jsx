  ...
  if (data.length === 0) {
    return (
      <Box textAlign="center" mt={5}>
        <Typography variant="h4" color="#a0a0a0">
          No Post Available
        </Typography>
      </Box>
    );
    ...
    >
      <TableContainer component={Paper} sx={{ width: "100%" }}>
        <Table aria-label="simple table">
          <TableHead sx={{ backgroundColor: '#ffffff', borderLeft: "4px solid #ff00c8", boxShadow: "0 0 10px rgba(255, 0, 200, 0.1)", position: "sticky" }}>
            <TableRow>
              ...
              <TableCell sx={{ fontWeight: "bold", color: "#a0a0a0", textAlign:"center" }}>
                Reactions
              </TableCell>
              <TableCell sx={{ fontWeight: "bold", color: "#a0a0a0", textAlign:"center" }}>
                Comments
