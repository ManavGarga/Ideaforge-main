  ...
  return (
    <Box
      sx={{
        ...
        alignItems: "center",
        padding: "2rem",
        backgroundColor: '#ffffff', borderLeft: '4px solid #2563eb', boxShadow: "0 0 10px rgba(0, 243, 255, 0.1)", color: "#a0a0a0",
        borderRadius: "5px",
        maxWidth: "1280px",
        margin: "2rem auto",
      }}
    >
      <Box sx={{ marginRight: "2rem" }}>
        <Typography variant="h4" component="h1" gutterBottom color="#a0a0a0">
