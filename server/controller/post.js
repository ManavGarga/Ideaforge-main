...
const searchPosts = async (req, res) => {
    try {
        ...
        // Search in title, description, or tags for the term (case insensitive)
        ...
        return res.status(200).json({ status: true, message: "Search Successful", posts });
...
export { addPost, removePost, editPost, getAllPost, getSinglePost, addComment, addReaction, handleVisibility, searchPosts };